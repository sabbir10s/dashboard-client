        ...
        <div className="flex flex-col overflow-y-auto md:flex-row">
          ...
          <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div className="w-full">
              ...
              <button
                className="flex items-center align-bottom justify-center cursor-pointer leading-5 transition-colors duration-150 bg-gray-100 hover:bg-primary-700 text-gray-800 hover:text-white font-medium px-4 py-2 rounded focus:outline-none text-sm bg-green-500 border border-transparent active:bg-green-600 w-full mt-4 h-12 mb-3"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <button
                className="flex items-center align-bottom justify-center cursor-pointer leading-5 transition-colors duration-150 bg-gray-100 hover:bg-error-600 text-gray-800 hover:text-white font-medium px-4 py-2 rounded focus:outline-none text-sm bg-green-500 border border-transparent active:bg-green-600 w-full mt-4 h-12"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
